...
namespace ET.Client
{
    ...
    public static class NumericComponentCSystem
    {
        ...
        public static void Reset(this NumericComponentC self)
        {
            //重置所有属性
            long max = NumericType.Max;
        ...
        private static void Update(this NumericComponentC self, int numericType, long value, bool notice = true, bool check = false,
        ...
        private static long GetByKey(this NumericComponentC self, int key)
        {
            long value = 0;
        ...
        public static long ReturnGetFightNumLong(this NumericComponentC self, int numericType, bool notice = true)
        {
            if (numericType < NumericType.Max)
            {
        ...
        public static float ReturnGetFightNumfloat(this NumericComponentC self, int numericType, bool notice = true)
        {
            if (numericType < NumericType.Max)
            {
                numericType = numericType * 100;
        ...
        public static void ApplyValue(this NumericComponentC self, int numericType, double value, bool notice = true)
        {
        ...
        public static void ApplyChange(this NumericComponentC self, int numericType, long changedValue, bool notice = true, bool check = false,
        long attackid = 0, int skillId = 0, int damgeType = 0)
        {
            //改变值为0不做任何处理
            if (changedValue == 0)
    ...
    public class NumericComponentC : Entity, IAwake, ITransfer, IUnitCache
    {
