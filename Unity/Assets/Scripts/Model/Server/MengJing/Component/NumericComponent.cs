...
namespace ET.Server
{
    ...
    {
        //重置所有属性
        public static void ResetProperty(this NumericComponent self)
        {
        ...
        private static void Update(this NumericComponent self, int numericType, long value, bool notice = true, bool check = false, long attackId = 0, int skillId = 0, DamageType damageType = 0)
        {
            long old = 0;
            int nowValue = 0;
        ...
        public static long ReturnGetFightNumLong(this NumericComponent self, int numericType, bool notice = true)
        {
            if (numericType < NumericType.Max)
            {
        ...
        public static float ReturnGetFightNumfloat(this NumericComponent self, int numericType, bool notice = true)
        {
            if (numericType < NumericType.Max)
            {
                numericType = numericType * 100;
        ...
        public static void ApplyValue(this NumericComponent self, int numericType, double value, bool notice = true)
        {
            self.ApplyValue(numericType, (long)(value * 10000), notice);
        }

        public static void ApplyValue(this NumericComponent self, int numericType, long value, bool notice = true, bool check = true, long attackid = 0, int skillId = 0, DamageType damgeType = 0)
        {
        ...
        /// </summary>
        public static void ApplyChange(this NumericComponent self, int numericType, long changedValue, bool notice = true, bool check = false, long attackid = 0, int skillId = 0, DamageType damgeType = 0)
        {
            //改变值为0不做任何处理
