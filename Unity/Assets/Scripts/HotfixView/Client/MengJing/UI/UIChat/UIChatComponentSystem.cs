...
namespace ET.Client
{
    ...
    public static partial class UIChatComponentSystem
    {
        ...
        private static void Awake(this UIChatComponent self)
        {
            ...
            self.Button_Type_World = rc.Get<GameObject>("Button_World").GetComponent<Button>();
            self.Button_Type_LianMeng = rc.Get<GameObject>("Button_LianMeng").GetComponent<Button>();
