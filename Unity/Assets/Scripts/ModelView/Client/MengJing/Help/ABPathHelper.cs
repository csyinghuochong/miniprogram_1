...
namespace ET
{
    ...
    public static class ABPathHelper
    {
        ...
        public static string GetMapConfigPath(string fileName)
        {
            ...
            prefabPath = ZString.Format("Assets/Bundles/MapConfig/{0}.bytes", fileName);
        ...
        public static string GetSceneUnitPath(string fileName)
        {
            ...
            prefabPath = ZString.Format("Assets/Bundles/Unit/Scene/{0}.prefab", fileName);
        ...
        public static string GetRecastPath(int text)
        {
            ...
            prefabPath = ZString.Format("Assets/Bundles/Recast/{0}.bytes", text);
